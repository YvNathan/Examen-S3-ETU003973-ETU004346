...
<head>
  ...
  <style>
    ...
    .panel h1 { margin: 0 0 0.5rem 0; color: #0f1f3a; }
    .panel p { margin: 0 0 1.25rem 0; color: #475569; }
    .cta {
    ...
    .cta:hover { transform: translateY(-1px); box-shadow: 0 20px 40px rgba(31, 111, 235, 0.4); }
  </style>
</head>
<body>
